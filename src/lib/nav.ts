...
const studentItems: NavItem[] = [
  ...
  { label: "Accessibility DNA", icon: Accessibility, to: "/access" },
  { label: "Interview practice", icon: Mic, to: "/practice" },
  { label: "Divyangjan hub", icon: HeartHandshake, to: "/accessibility" },
...
const employerItems: NavItem[] = [
  ...
  { label: "Accessibility profile", icon: Accessibility, to: "/employer/accessibility" },
